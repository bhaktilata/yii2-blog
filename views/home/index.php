        ...
        <div class="container pt-lg-5 pt-md-4">
                        ...
                        <div class="col-lg-5 col-md-6 item">
                            <div class="card">
                                <div class="card-header p-0 position-relative">
                                    <a href="#blog-single">
                                        <?= Html::img('@web/images/b1.jpg', ['alt' => 'руны русичей', 'class' => 'card-img-bottom d-block radius-image']) ?></a>
                                    </a>
                                </div>
                            ...
                            <div class="list-view list-view1">
                                <div class="grids5-info">
                                    <a href="#blog-single" class="d-block zoom">
                                        <?= Html::img('@web/images/1.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                                        </a>
                                ...
                                <div class="grids5-info mt-5">
                                    <a href="#blog-single" class="d-block zoom">
                                        <?= Html::img('@web/images/2.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                                    <div class="blog-info align-self">
                                ...
                                <div class="grids5-info mt-5">
                                    <a href="#blog-single" class="d-block zoom">
                                        <?= Html::img('@web/images/3.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                                    </a>
                                    <div class="blog-info align-self">
            ...
            <div class="item mt-5 pt-4">
                <div class="row">
                    <div class="col-lg-6">
                        <a href="#blog-single">
                            <?= Html::img('@web/images/p3.jpg', ['alt' => 'руны русичей', 'class' => 'card-img-bottom d-block radius-image']) ?>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="list-view list-view1">
                            <div class="grids5-info">
                                <a href="#blog-single" class="d-block zoom">
                                    <?= Html::img('@web/images/4.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                                <div class="blog-info align-self">
                            ...
                            <div class="grids5-info mt-5">
                                <a href="#blog-single" class="d-block zoom">
                                    <?= Html::img('@web/images/5.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                                </a>
                               </a>
                                <div class="blog-info align-self">
                    ...
                    <div class="col-lg-5 col-md-6 mt-md-0 mt-5">
                        <div class="list-view list-view1">
                            <div class="grids5-info">
                                <a href="#blog-single" class="d-block zoom">
                                    <?= Html::img('@web/images/6.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                                </a>
                                <div class="blog-info align-self">
                            ...
                            <div class="grids5-info mt-5">
                                <a href="#blog-single" class="d-block zoom">
                                    <?= Html::img('@web/images/7.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                                </a>
                                <div class="blog-info align-self">
                    ...
                    <div class="col-lg-2 col-sm-6 mt-lg-0 mt-5">
                        <div class="ad-img">
                            <a href="#ad-img">
                                <?= Html::img('@web/images/ad1.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid']) ?></a>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="list-view ">
                        <div class="grids5-info img-block-mobile">
                            ...
                            <a href="#blog-single" class="d-block zoom mt-md-0 mt-3">
                                <?= Html::img('@web/images/8.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                               </a>
                        </div>
                        ...
                        <div class="grids5-info img-block-mobile mt-5">
                            ...
                            <a href="#blog-single" class="d-block zoom mt-md-0 mt-3">
                                <?= Html::img('@web/images/9.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                                </a>
                        </div>
                        ...
                        <div class="grids5-info img-block-mobile mt-5">
                            ...
                            <a href="#blog-single" class="d-block zoom mt-md-0 mt-3">
                                <?= Html::img('@web/images/16.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                                </a>
                        </div>
                        ...
                        <div class="row most-recent-inner my-5 py-lg-4">
                            <div class="col-md-6">
                                <div class="list-view list-view1">
                                    <div class="grids5-info">
                                        <a href="#blog-single" class="d-block zoom">
                                            <?= Html::img('@web/images/10.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                                            </a>
                                        <div class="blog-info align-self">
                                    ...
                                    <div class="grids5-info mt-5">
                                        <a href="#blog-single" class="d-block zoom">
                                         <?= Html::img('@web/images/11.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?>
                            ...
                            <div class="col-md-6 mt-md-0 mt-5">
                                <div class="list-view list-view1">
                                    <div class="grids5-info">
                                        <a href="#blog-single" class="d-block zoom">
                                            <?= Html::img('@web/images/12.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                                    ...
                                    <div class="grids5-info mt-5">
                                        <a href="#blog-single" class="d-block zoom">
                                            <?= Html::img('@web/images/13.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                                        </a>
                                        <div class="blog-info align-self">
                        ...
                        <div class="grids5-info img-block-mobile mt-5">
                            ...
                            <a href="#blog-single" class="d-block zoom mt-md-0 mt-3">
                                <?= Html::img('@web/images/14.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                            </a>
                        </div>
                        ...
                        <div class="grids5-info img-block-mobile mt-5">
                            ...
                            <a href="#blog-single" class="d-block zoom mt-md-0 mt-3">
                                <?= Html::img('@web/images/15.jpg', ['alt' => 'руны русичей', 'class' => 'img-fluid radius-image news-image']) ?></a>
                            </a>
                        </div>
            ...
            <div class="ad-block text-center mt-5">
                <a href="#url">
                    <?= Html::img('@web/images/ad.gif', ['alt' => 'руны русичей', 'class' => 'img-fluid']) ?>
                    </a>
            </div>
            <!-- //ad block -->
